...
\newwatermark[firstpage,color=red!50, angle=45, scale=1, xpos=-15, ypos=12]{\sffamily DRAFT! Do not quote!}
...
Participants received no payment but credit in partial fulfilment of the requirements for the above mentioned classes.
