...
% \newcommand{\citealt}[2][]{\citealt[#1]{#2}}

\journalname{Submitted to Morphology}
\title{The interpretability of compound linking elements in German\thanks{The first author's work on this project was funded in part by the German Research Council (Deutsche Forschungsgemeinschaft, DFG, personal grant SCHA1916/1-1}}
