...
However, Augst (given the lack of searchable corpora at the time) only analysed forms listed in normative dictionaries, which list lexicalised forms and not productively formed compounds.
