...
\begin{table}[htbp]
  \resizebox{\textwidth}{!}{
    \begin{tabular}{lllll}
    \toprule
    Element & Pl & example & literal gloss & translation \\
    \midrule
