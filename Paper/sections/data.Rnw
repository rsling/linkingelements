...
Since they were removed for all further analysis reported below, the frequencies in the table are higher, espescially for \textit{-n} and \textit{-en}, which are the hypothetical PLs of the weak nouns.}
...
<<proddots, png=TRUE, pdf=FALSE, fig.pos="htbp", fig.height=8, fig.cap="Comparisons of the potential productivity of N1s, grouped by PLs; colours and sizes encode the type frequencies with PL and NPL; axes are on a logarithmic scale">>=
