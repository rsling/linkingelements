...
<<proddots, fig.pos="htb!", fig.height=8, fig.cap="Comparisons of the potential productivity (Prod) of first constituents, grouped by their PL; colours and sizes encode the type frequencies with PL and NPL">>=
