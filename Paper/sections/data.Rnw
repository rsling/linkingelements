...
\end{center}
\caption{Comparisons of the potential productivity (Prod) of first constituents, grouped by their PL; colors and sizes encode the type frequencies with PL and NPL}
\label{fig:proddots}
\end{figure}
