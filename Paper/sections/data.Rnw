...
Readers should keep in mind that we searched for first constituents which at least sometimes occur with a PL, but we also generated the relevant counts for these first constituents appearing with a NPL.
