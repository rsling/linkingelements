...
The goal is to accept either of these hypotheses, where typically H\Sub{M} is the hypothesis predicted by the experimenter's favoured theory.
The reason why the Neyman-Pearson approach can be hard to implement is that H\Sub{M} needs to be specified precisely including the effect size.
