...
However, since the interpretation of this kind of containment compound is context- and world-knowledge-dependent, we refer to these as extended cases and will analyse them separately from the clear-cut cases shown above.
