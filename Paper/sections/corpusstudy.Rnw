...
Since in the corpus study we had to assume that there were more confounding factors anyway, we did not include such cases to be on the safe side.
}
...
We adopt the statistical philosophy of Ronald A.\ Fisher, and readers not familiar with the debate or the different traditions are encouraged to read Appendix~\ref{sec:onstatisticalanalysis}.}
