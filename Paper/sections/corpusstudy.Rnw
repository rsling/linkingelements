...
Figure~\ref{fig:corpuseffects} shows for each N1 the signed effect strength in the internal plural condition as its location on the horizontal dimension as well as the p-value through the colour coding.
