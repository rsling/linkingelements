...
extpl.obs.xt <- xtable(nice.int(extpl.obs), booktabs = T,
                         caption = "Contingency table for external plural (= plural agreement) sub-study",
...
extpl.resid.xt <- xtable(nice.float(extpl.resid), booktabs = T,
                         caption = "Standardised residuals from $\\chi^2$ test of external plural (= plural agreement) sub-study",
