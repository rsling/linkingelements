...
<<setupcorpus, cache=FALSE, echo=FALSE, include=FALSE, results='asis'>>=
...
<<corpusselection, fig.pos="H", fig.height=8, fig.cap="Scatterplot of p-values", echo=FALSE>>=
...
<<corpuseffects, fig.pos="H", fig.height=10, fig.cap="Scatterplot of p-values", echo=FALSE>>=
