...
extpl.resid.xt <- xtable(nice.float(extpl.resid), booktabs = T,
                         caption = "Residuals from chi square test of external plural (= plural agreement) hypothesis",
...
At least for the lax annotation scheme, $v\geq 0.2$ and thus at least worthy of mention.
...
The more unmarked and thus the more type-frequent a plural marker is, the stronger it tends to be interpreted as a plural marker even as a linking element.
