...
<<experimentselection, fig.pos="H", fig.height=8, fig.cap="Scatterplot of p-values">>=
...
<<conditions, fig.pos="H", fig.height=6, fig.cap="Distribution of Split-100 responses by conditions">>=
...
<<participants, fig.pos="H", fig.height=6, fig.cap="Distribution of individual Split-100 responses by conditions">>=
par(mfrow=c(2,1))
