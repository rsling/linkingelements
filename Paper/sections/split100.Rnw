...
<<setupsplit, cache=FALSE, echo=FALSE, include=FALSE, results='asis'>>=
...
<<experimentselection, fig.pos="H", fig.height=8, fig.cap="Scatterplot of p-values", echo=FALSE>>=
...
<<conditions, fig.pos="H", fig.height=8, fig.cap="Distribution of Split-100 responses by conditions", echo=FALSE>>=
...
<<participants, fig.pos="H", fig.height=8, fig.cap="Distribution of individual Split-100 responses by conditions", echo=FALSE>>=
par(mfrow=c(2,1))
...
<<betainfl, message=FALSE, warning=FALSE, results='hide', error=FALSE, echo=FALSE>>=
