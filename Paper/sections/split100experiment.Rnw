...
<<participants, fig.pos="htbp", fig.height=6, fig.cap="Distribution of individual split-100 responses in the internal plural sub-experiment by conditions; subjects were ordered by their mean ratings", message=FALSE, warning=FALSE, error=FALSE>>=
