...
Regardless of diachronic development, writers use PLs as cues to the interpretation of N1+N2 compounds (see also \citealt[212]{BangaEa2013b}).
...
A clear case are words ending in full vowels, which have an \textit{-s} plural but resist \textit{-s} linkages strongly (though see \textcite{Fehringer2009} for an investigation of an emerging \textit{-s} PL in northern German dialects).
