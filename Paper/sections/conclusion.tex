...
Regardless of the diachronic development of LEs, writers use PLs as cues to the interpretation of N1+N2 compounds (see also \citealt[212]{BangaEa2013b}).
...
For example, \textit{Auto-s+kollektion} `car collection' is very unexpected -- according to some sources even impossible \citep{Wegener2003,Fuhrhop1996} -- and \textit{Auto-kollektion} would be preferred by a huge margin.
