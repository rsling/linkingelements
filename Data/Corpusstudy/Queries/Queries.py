...
Queries = [
  ...
  u'Kerl(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Exponat(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Kompliment(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Umstieg(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  ...
  u'Forderung(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Möglichkeit(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Portion(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Praktik(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  ...
  u'Vorgang(_\(e\)_\+s_|_\+s_|_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  ...
  u'Ausrede(_\(e\)_\+s_|_\+s_|_|_-e_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Hüfte(_\(e\)_\+s_|_\+s_|_|_-e_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Wunde(_\(e\)_\+s_|_\+s_|_|_-e_)[A-ZÄÖÜ][a-zäöüßéè]+$',
  ...
  u'Kerl_\+e_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Exponat_\+e_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Kompliment_\+e_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Umstieg_\+e_[A-ZÄÖÜ][a-zäöüßéè]+$',
  ...
  u'Forderung_\+en_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Möglichkeit_\+en_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Portion_\+en_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Praktik_\+en_[A-ZÄÖÜ][a-zäöüßéè]+$',
  ...
  u'Vorgang_\+=e_[A-ZÄÖÜ][a-zäöüßéè]+$',
  ...
  u'Ausrede_\+n_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Hüfte_\+n_[A-ZÄÖÜ][a-zäöüßéè]+$',
  u'Wunde_\+n_[A-ZÄÖÜ][a-zäöüßéè]+$'
]
...
for Q in Queries:
  ...
  query = cow_query(realq.encode('utf-8'), corpus = CORPUS, references = REFERENCES,
    attributes = ATTRIBUTES, structures = STRUCTURES, deduping = True,
    max_hits = MAX_HITS)
